...
: m_camera(camera), m_dayLength(250), m_time(m_dayLength/5), m_day(0), m_orbitAngle(0.0), m_phase(0), m_sunAxis(0.5), m_moonAxis(1.0), m_pulse(0.0) {
...
Vec3f Environment::getcUp()
{
	...
	return Vec3f(0.2 * help, 0.2 * help, 0.8 * help);
